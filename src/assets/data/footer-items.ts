...
const footerLinks: FooterLink[] = [
  {
    ...
    items: [
      ...
      // { name: 'Oficinas', link: '/oficinas' },
      { name: 'Agentes', link: '/advisors' },
    ...
    items: [
      {
        ...
        offices: [
          { name: "Caracas", link: '', icon: '', address: "Av. Francisco de Miranda, Torre Cavendes, oficina 6-02." },
          { name: "Valencia", link: '', icon: '', address: "Av. Bolívar Norte, Torre Majay, oficina principal." },
          { name: "Barquisimeto", link: '', icon: '', address: "Av. Los Leones, CC. Los Leones, Local #24." },
        ],
      },
      {
        name: "España",
        ...
        offices: [
          { name: "Madrid", link: '', icon: '', address: "Calle Alcalá 22. Piso 2, puerta DR. 28014. Madrid" },
          { name: "Barcelona", link: '', icon: '', address: "Calle Valencia 83 entresuelo. 08029" },
        ],
      },
      {
        name: "Argentina",
        ...
        offices: [
          { name: "Buenos Aires", link: '', icon: '', address: "Lavalle 669 Local 12, C1047AAM Cdad. Autónoma de Buenos Aires" },
        ],
      },
      {
        name: "Colombia",
        ...
        offices: [
          { name: "Medellín", link: '', icon: '', address: "El Poblado - Carrera 43 A # 5A - 113 One Plaza Bussines Center Piso 7 Int 713" },
          { name: "Bogotá", link: '', icon: '', address: "Edificio Varese, calle 98 #18-7. Bogotá DC" },
        ],
      },
      {
        name: "Estados Unidos",
        ...
        offices: [
          { name: "Miami", link: '', icon: '', address: "8350 nw 52ter Suite 301 doral Florida 33166 oficina 199." },
        ],
      },
      {
        name: "Panamá",
        ...
        offices: [
          { name: "Panamá", link: '', icon: '', address: "Av. Centenario, Torre Aseguradora Ancon, oficina 14K, Costa del Este, Panamá." },
        ],
      },
      {
        name: "Perú",
        ...
        offices: [
          { name: "Lima", link: '', icon: '', address: "Centro Comercial Caminos del Inca, Avenida Caminos del Inca 257 – 269, 3er piso oficina 326." },
        ],
      },
      {
        name: "Chile",
        ...
        offices: [
          { name: "Santiago de Chile", link: '', icon: '', address: "Serrano 73, torre Snap, piso 3 oficina 313. Stgo. Chile." },
        ],
      },
      {
        name: "Ecuador",
        ...
        offices: [
          { name: "Quito", link: '', icon: '', address: "Av. Moscú y Av. Noruega, Edificio Moscú Platz, piso 1, oficina 4." },
        ],
      },
    ],
  },
